...
const HasSnapPointsContext = React.createContext(false);
const ModalContext =
  React.createContext<DrawerPrimitive.Root.Props['modal']>(true);
const ShowSwipeHandleContext = React.createContext(false);
const SwipeDirectionContext =
  React.createContext<
...
const Drawer = ({
  ...
  return (
    <HasSnapPointsContext.Provider value={hasSnapPoints}>
      <ModalContext.Provider value={modal}>
        <ShowSwipeHandleContext.Provider value={showSwipeHandle}>
        ...
        </ShowSwipeHandleContext.Provider>
      </ModalContext.Provider>
    </HasSnapPointsContext.Provider>
  );
};
...
const DrawerContent = ({
  ...
  const hasSnapPoints = React.useContext(HasSnapPointsContext);
  const modal = React.useContext(ModalContext);
  const showSwipeHandle = React.useContext(ShowSwipeHandleContext);
  const swipeDirection = React.useContext(SwipeDirectionContext);
  const swipeAxis =
